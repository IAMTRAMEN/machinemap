{{-- resources/views/admin/simple-relationships/create.blade.php --}}
            ...
            <form action="{{ route('admin.relationships.store') }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="relationship_type" id="relationship_type" 
                                ...
                                <option value="customer" {{ old('relationship_type') == 'customer' ? 'selected' : '' }}>Customer</option>
                                <option value="provider" {{ old('relationship_type') == 'provider' ? 'selected' : '' }}>Provider</option>
                                <option value="partner" {{ old('relationship_type') == 'partner' ? 'selected' : '' }}>Partner</option>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" id="description" 
                              ...
                              rows="4" placeholder="Enter any notes or description...">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
